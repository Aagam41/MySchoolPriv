...
from aagam_packages.terminal_yoda.terminal_yoda import yoda_saberize_print
...
IS_DEVELOPMENT = bool(environ['MYSCHOOL_SETTINGS_DEVELOPMENT'] == "True")

ALLOWED_HOSTS = []

# region Aagam Sheth Logging
# Logging
LOGGING = {
    'version': 1,
...
DATABASES = {
    ...
    'pred': {
        ...
        'NAME': f'{BASE_DIR}/sqlite3.db',
    }
}

DATABASE_ROUTERS = [
    'StudentPerformancePrediction.routers.PredictionDataRouter',
]
