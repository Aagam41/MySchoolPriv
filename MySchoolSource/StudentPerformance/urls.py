...
urlpatterns = [
    ...
    path('paper-entry-form/create1/<str:app_label>/<str:model_label>',
         views.ModelObjectCreateView.as_view(), name='model-object_create_view'),

    path('paper-entry-form/delete1/<str:app_label>/<str:model_label>/<int:pk>',
         views.ModelObjectDeleteView.as_view(), name='model-object_delete_view'),
    path('paper-entry-form/delete1/<str:app_label>/<str:model_label>/<int:pk>/<str:template_label>',
         views.ModelObjectDeleteView.as_view(), name='model-object_delete_view'),
    path('paper-entry-form/delete1/<str:app_label>/<str:model_label>/<int:pk>/<str:template_label>/<str:success_label>',
         views.ModelObjectDeleteView.as_view(), name='model-object_delete_view'),
]
