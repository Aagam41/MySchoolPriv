...
def train_linear_regression_model():
    ...
    for i in range(10000):
        ...
        if best_accuracy < accuracy:
            with open("StudentPerformancePrediction/AagamMachineLearningModels/mdl_linear_regression.pickle", "wb") as regression_file:
    ...
    if is_debugger_attached:
        pickled_model = open("StudentPerformancePrediction/AagamMachineLearningModels/mdl_linear_regression.pickle", "rb")
