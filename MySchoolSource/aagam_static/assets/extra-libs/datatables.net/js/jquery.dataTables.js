...
(function( $, window, document, undefined ) {
	...
	/**
	 * Take the column definitions and aagam_static columns arrays and calculate how
	...
	{
		// Only extend API instances and aagam_static properties of the API
	...
	DataTable.defaults = {
		 ...
		 * during initialisation in addition to through the aagam_static
	...
	DataTable.ext = _ext = {
		 ...
		 * than just the aagam_static string that DataTables knows of.
		 *
